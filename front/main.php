...
<div class="tags">
    <div id="tag1" class="tag active">健康新知</div>
    <div id="tag2" class="tag">菸害防制</div>
    <div id="tag3" class="tag">癌症防治</div>
    <div id="tag4" class="tag">慢性病防治</div>
</div>
<article>
    <section id="sec1">
        <h1>健康新知</h1>
...
<script>
    $(".tag").on("click",function(){
        ...
        let id=$(this).attr('id').replace('tag','sec');
        $("section").hide();
        $("#"+id).show();
    })
</script>